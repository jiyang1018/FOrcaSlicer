...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionEnum<SeamPosition>,  outer_wall_seam_position))
...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionInt, outer_wall_loops))
    ((ConfigOptionFloat, outer_wall_layer_height_max))
...
PRINT_CONFIG_CLASS_DERIVED_DEFINE(
    ...
    ((ConfigOptionFloat,              filament_color_depth))
    ...
    ((ConfigOptionBool,               has_mixed_nozzle_sizes))
