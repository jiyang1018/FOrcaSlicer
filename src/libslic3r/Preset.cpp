...
static std::vector<std::string> s_Preset_print_options {
    ...
    "filename_format", "wall_filament", "inner_wall_filament", "support_bottom_z_distance",
    ...
    "tower_line_width", // FOS 8.5: per-nozzle prime tower line width, authored in the nozzle notebook
    "wipe_tower_no_sparse_layers", "compatible_printers", "compatible_printers_condition", "inherits",
    "flush_into_infill", "flush_into_objects", "flush_into_support",
    // FOS 8.6.5: dynamic support / prime tower nozzle pools
    "fos_support_nozzle_pool", "fos_support_interface_nozzle_pool", "fos_wipe_tower_nozzle_pool",
...
static std::vector<std::string> s_Preset_filament_options {
    /*"filament_colour", */ "default_filament_colour","required_nozzle_HRC","filament_diameter", "pellet_flow_coefficient", "filament_type", "filament_soluble", "filament_is_support", "fos_filament_transparent", "fos_filament_translucency", "color_patch_enabled", "color_patch_loops",
    ...
    "temperature_vitrification", "filament_is_high_temperature", "reduce_fan_stop_start_freq","dont_slow_down_outer_wall", "slow_down_for_layer_cooling", "fan_min_speed",
