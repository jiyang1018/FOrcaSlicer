...
nullptr : &this->layer()->color_patch_is_top_bottom;
    ...
    const bool is_cp = g.color_patch_regions != nullptr
        ...
        && (g.color_patch_loops_effective != nullptr
            && g.config->wall_filament.value - 1 < (int)g.color_patch_loops_effective->size()
            ? (*g.color_patch_loops_effective)[g.config->wall_filament.value - 1]
