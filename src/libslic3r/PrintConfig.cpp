...
void PrintConfigDef::init_fff_params()
{
    ...
    def->category = L("Quality");
    def->tooltip = L("Line width of outer wall. Set to 0 to use the Default line width. If expressed as a %, it will be computed over the nozzle diameter.");
    def->sidetext = L("mm or %");
    ...
    */
    ...
    def->label = L("Sparse infill");
    def->category = L("Quality");
    def->tooltip = L("Line width of internal sparse infill. Set to 0 to use the Default line width. If expressed as a %, it will be computed over the nozzle diameter.");
    def->sidetext = L("mm or %");
    def->ratio_over = "nozzle_diameter";
    def->min = 0;
    def->max = 1000;
    ...
    def->label = L("Inner wall");
    def->category = L("Quality");
    def->tooltip = L("Line width of inner wall. Set to 0 to use the Default line width. If expressed as a %, it will be computed over the nozzle diameter.");
    def->sidetext = L("mm or %");
    def->ratio_over = "nozzle_diameter";
    def->min = 0;
    def->max = 1000;
...
def = this->add("outer_wall_layer_height_max", coFloat);
    ...
    def->label = L("Internal solid infill");
    def->category = L("Quality");
    def->tooltip = L("Line width of internal solid infill. Set to 0 to use the Default line width. If expressed as a %, it will be computed over the nozzle diameter.");
    def->sidetext = L("mm or %");
    def->ratio_over = "nozzle_diameter";
    def->min = 0;
    def->max = 1000;
...
//    def->min = 0;
    ...
    def->category = L("Support");
    def->tooltip = L("Which nozzles may print the support base when Support/raft base is set to Custom. All selected nozzles must have the same diameter.");
    def->mode = comAdvanced;
    def->set_default_value(new ConfigOptionBools{ false });
    ...
    def->label = L("Support");
    def->category = L("Quality");
    def->tooltip = L("Line width of support. Set to 0 to use the Default line width. If expressed as a %, it will be computed over the nozzle diameter.");
    def->sidetext = L("mm or %");
    def->ratio_over = "nozzle_diameter";
    def->min = 0;
    def->max = 1000;
    ...
    def->category = L("Support");
    def->tooltip = L("Which nozzles may print the support interface when Support/raft interface is set to Custom. All selected nozzles must have the same diameter.");
    def->mode = comAdvanced;
    def->set_default_value(new ConfigOptionBools{ false });
    ...
    def->label = L("Top surface");
    def->category = L("Quality");
    def->tooltip = L("Line width for top surfaces. Set to 0 to use the Default line width. If expressed as a %, it will be computed over the nozzle diameter.");
    def->sidetext = L("mm or %");
    def->ratio_over = "nozzle_diameter";
    def->min = 0;
    def->max = 1000;
    ...
    def->label = L("Wipe tower wall nozzles");
    def->category = L("Extruders");
    def->tooltip = L("Which nozzles may print the prime tower wall when Wipe tower wall is set to Custom. All selected nozzles must have the same diameter.");
    def->mode = comAdvanced;
    def->set_default_value(new ConfigOptionBools{ false });
