...
public:
    ...
    DynamicPrintConfig          full_config(bool fos_remap_by_filament = true) const;
    // full_config() with the some "useless" config removed.
    DynamicPrintConfig          full_config_secure(bool fos_remap_by_filament = true) const;
...
private:
    ...
    DynamicPrintConfig          full_fff_config(bool fos_remap_by_filament = true) const;
